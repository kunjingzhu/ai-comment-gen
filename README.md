...
[![Version](https://img.shields.io/badge/version-0.1.7-blue)](https://github.com/1552394362/ai-comment-gen/releases)
...
- **整文件注释** — 右键「AI 为整个文件添加注释」，自动扫描未注释的函数并批量生成
...
1. 下载最新 `.vsix` 文件：
   - [GitHub Releases](https://github.com/1552394362/ai-comment-gen/releases) → 下载最新的 `ai-comment-gen-x.x.x.vsix`
...
> 💡 **获取 API Key**：注册 [DeepSeek](https://platform.deepseek.com/) → 创建 API Key → 新用户赠送 500 万 token 免费额度
